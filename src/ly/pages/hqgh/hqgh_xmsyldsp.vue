  ...
  <el-row class="tlw-row">
    <el-col :span="24">
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column prop="country" label="县" width="120" />
        ...
        <el-table-column
          ...
          width="120"
        />
        <el-table-column prop="gymj" label="国有面积（公顷）" width="120" />
        <el-table-column prop="jtmj" label="集体面积（公顷）" width="120" />
        <!-- <el-table-column
          prop="slzbhff"
          label="森林植被恢复费（元）"
          width="120"
...
import { queryPage, downLoadModel, batchImport } from "@/ly/api/proj/xmsyldsp";
