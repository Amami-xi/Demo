<template>
  <el-dialog v-model="dialogVisible" :title="title" :before-close="handleClose">
    <el-card header="植物检疫申报信息表" class="tlw-card">
      <el-form
        :model="entity"
        ref="zwjyform"
        label-width="auto"
      ...
      >
        <table class="tlw-table">
          ...
          <tr>
            ...
            <td>月份</td>
            <td colspan="3" style="width: 35%">
              <el-form-item prop="month" label-width="0">
                <el-select
          ...
          <tr>
            <td class="requireCol">办件量</td>
            <td class="requireCol">省内办件量</td>
            <td colspan="3">
              <el-form-item label-width="0" prop="amountIn" :rules="rules.intNum" class="el-form-item__error_show">
                <el-input v-model="entity.amountIn" :disabled="disabled" />
              </el-form-item>
            </td>
            <td class="requireCol">省外办件量</td>
            <td colspan="3">
              <el-form-item prop="amountOut" label-width="0" :rules="rules.intNum" class="el-form-item__error_show">
                <el-input v-model="entity.amountOut" :disabled="disabled" />
              </el-form-item>
            </td>
          </tr>
        </table>
