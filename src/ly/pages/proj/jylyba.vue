    ...
    >
      <table class="tlw-table">
        ...
        <tr>
          ...
          <td colspan="6">
            <el-form-item prop="jbxx.spqx" :rules="rules.requiredChange">
              <el-radio-group v-model="entity.jbxx.spqx" @change="F_bhjb(2)">
                <el-radio
        ...
        <tr>
          ...
          <td colspan="5">
            <el-form-item prop="jbxx.sqrlxdh" :rules="rules.phone" class="el-form-item__error_show">
              <el-input v-model="entity.jbxx.sqrlxdh" :disabled="disabled" />
            </el-form-item>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="4">
            <el-form-item prop="jbxx.spsxnr" :rules="rules.requiredField">
              <el-input
...
import { init, saveOrUpdate, deleteLx } from "@/ly/api/proj/jyly-ba";
...
import { getRules, checkValidate } from "@/ly/verification/jylyba";
...
const F_beforeSave = async () => {
  let flag = true;
  //1. 表单判空
  await jylybaform.value.validate((valid) => {
    flag = valid;
    //2. 自己的逻辑代码
    if (flag) {
