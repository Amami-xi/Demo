<template>
  ...
  >
    ...
    <el-table-column prop="codeValue" label="地类编码" width="220">
    ...
    <el-table-column prop="codeName" label="地类名称" width="300">
      <template #default="scope">
        <div v-if="scope.row.saveFlag == 1">
          <el-input
            placeholder="请填写地类名称"
  ...
  <lydl_add ref="lydlAdd" :render="F_init"></lydl_add>
</template>
...
import lydl_add from "./lydl_add.vue";
