    ...
    <el-col :span="12">
      ...
      >
        <el-table-column label="入库指标">
          <el-table-column prop="typeName" label="数据类型" width="110" />
...
import { getTdzzZbkdzdList } from "@/tdzz/api/zbgl/zbk/zbk_zbkdzd"
...
const data = reactive({
  ...
  ckzbTableList: [],
  rkzbChartList: [
    { name: "项目入库指标", value: 15 },
    { name: "调入指标", value: 15 },
    { name: "解挂入库指标", value: 15 },
    { name: "指标基库", value: 15 },
    { name: "部解锁指标", value: 15 },
    { name: "迁移入库指标", value: 15 },
    { name: "已借用指标", value: 15 },
    { name: "冻结指标", value: 15 },
  ],
  ckzbChartList: [
    ...
    { name: "冻结指标", value: 15 },
    { name: "核减指标", value: 15 },
    { name: "承诺兑现指标", value: 15 },
    { name: "历史挂钩指标", value: 15 },
    { name: "核查指标", value: 15 },
    { name: "已规划指标", value: 15 },
    { name: "部监管扣除", value: 15 },
    { name: "已用于国家统筹", value: 15 },
  ],
});

const { top, districtOptions, codeValue, options, queryParams, rkzbTableList, ckzbTableList } =
  toRefs(data);
...
const F_getTableList = () => {
  getTdzzZbkdzdList(data.queryParams).then((res) => {
