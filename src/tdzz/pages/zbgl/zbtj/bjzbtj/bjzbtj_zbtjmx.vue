<template>
  <el-form :inline="true" class="tlw-search">
    ...
    <el-row>
      <el-col :span="24">
        <el-button type="primary" @click="F_getBjzbtjList">查询</el-button>
      </el-col>
    </el-row>
  </el-form>
...
import { getTdzzBjzbtj } from "@/tdzz/api/zbgl/zbtj/bjzbtj/bjzbtj";
...
const F_getBjzbtjList = () => {
  getTdzzBjzbtj(data.queryParams).then((res) => {
