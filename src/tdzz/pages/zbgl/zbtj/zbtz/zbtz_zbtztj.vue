<template>
  <el-form :inline="true" class="tlw-search">
    ...
    <el-row>
      <el-col :span="24">
        <el-button type="primary" @click="F_getZbtztjList">统计</el-button>
      </el-col>
    </el-row>
  </el-form>
...
import { getTdzzZbtztj } from "@/tdzz/api/zbgl/zbtj/zbtz/zbtz";
...
const F_getZbtztjList = () => {
  getTdzzZbtztj(data.queryParams).then((res) => {
