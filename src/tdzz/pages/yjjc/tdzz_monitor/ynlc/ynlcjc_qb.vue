    ...
    <el-col :span="24">
      ...
      >
        ...
        <el-table-column label="下发状态" width="120" v-if="grade == 1">
          <template #default="scope">
            <el-tag type="warning" v-if="scope.row.ynlcState == 0"
              >未下发</el-tag
            >
        ...
        <el-table-column label="下发状态" width="120" v-if="grade == 2">
          <template #default="scope">
            <el-tag type="warning" v-if="scope.row.ynlcState == 1"
              >未下发</el-tag
            >
            <el-tag type="success" v-if="scope.row.ynlcState >= 2"
              >已下发</el-tag
            >
          </template>
        </el-table-column>
        <el-table-column label="上报状态" width="120" v-if="grade == 3">
          <template #default="scope">
            <el-tag type="warning" v-if="scope.row.ynlcState == 2"
              >未上报</el-tag
            >
            <el-tag type="success" v-if="scope.row.ynlcState >= 3"
              >已上报</el-tag
            >
          </template>
        </el-table-column>
...
import { getYjjbntlcList, getPcList } from "@/tdzz/api/yjjc/jc";
