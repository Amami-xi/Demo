<template>
  <el-container class="tlw-main">
    <el-aside class="tlw-main-left">
      <MenuTree :menuList="menuList" :defaultActive="defaultActive" :render="render" :menuTitle="parentMenuName">
      </MenuTree>
    </el-aside>
 ...
 */
const F_getMenuList = () => {
  getChildMenuList(import.meta.env.VITE_APP_TDZZ_NAME, data.parentMenuId).then(
    (res) => {
      //1.获取菜单列表
