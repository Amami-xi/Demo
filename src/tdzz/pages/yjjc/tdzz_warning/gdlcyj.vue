<template>
  <el-row class="tlw_bar">
    <el-col>
      <svg-icon name="wz" title="位置：预警 > 耕地流出预警"></svg-icon>
    </el-col>
  </el-row>
    ...
    <el-row>
      <el-col :span="24">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="F_send">发送 </el-button>
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
  ...
  <sendMsg ref="sendMessage" @refresh="F_refresh"></sendMsg>
  <RYXZ ref="ryxz"></RYXZ>
</template>
...
import sendMsg from "./sendMessage.vue";
...
const F_send = () => {
  sendMessage.value.handleOpen(data.selection);
};
