  ...
  <el-row class="tlw-row">
    <el-col :span="24">
      <el-table :data="tableData" border stripe @row-dblclick="openWorkbox">
        ...
        />
        <el-table-column prop="catalog" label="项目阶段" width="120" />
      </el-table>
      <pagination
...
import { getYibanList } from "@/tdzz/api/workflow/workflow";
 ...
 * 获取办结列表
 */
const F_getYibanList = () => {
  getYibanList(data.queryParams).then((res) => {
