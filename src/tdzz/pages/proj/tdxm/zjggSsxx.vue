...
<template>
  ...
  >
    <panel title="项目基本信息">
      ...
      <el-row>
        <el-col :span="10" :offset="1">
          <el-form-item label="批复工期" prop="ss.pfgq" :rules="rules.num">
...
import { getRules, checkValidate } from "@/tdzz/verification/zjggSs";
import { ref, reactive, toRefs } from "@vue/reactivity";
import { init, saveOrUpdate } from "@/tdzz/api/proj/proj-zjgg-ss";
...
onMounted(() => {
  ...
  F_init();
  //2.定义监听事件
  bus.on("zjgg_ssxx_save", async (callback) => {
