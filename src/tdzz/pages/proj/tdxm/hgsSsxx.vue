  ...
  >
    <panel title="项目基本信息">
      ...
      <el-row>
        ...
        <el-col :span="10" :offset="1">
          <el-form-item label="高标准基本农田任务所属年度" prop="ss.gmGbznd">
            <el-date-picker
              type="year"
              value-format="YYYY"
              :disabled="disabled"
...
import { getRules, checkValidate } from "@/tdzz/verification/hgsSs";
import { ref, reactive, toRefs } from "@vue/reactivity";
import { init, saveOrUpdate } from "@/tdzz/api/proj/proj-hgs-ss";
...
onMounted(() => {
  ...
  F_init();
  //2.定义监听事件
  bus.on("hgs_ssxx_save", async (callback) => {
