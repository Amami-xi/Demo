  ...
  >
    ...
    <panel title="复垦后现状地类">
      ...
      <el-row>
        ...
        <el-col :span="6" :offset="4">
          <el-form-item label="其他土地" prop="ys.fkhQttdmj" :rules="rules.num">
            <el-input
              :disabled="disabled"
    ...
    <panel title="占准确上报百分比(%)">
      <el-row>
        <el-col :span="6" :offset="4">
          <el-form-item label="新增农用地" prop="ys.zqsbNyd" :rules="rules.num">
            <el-input disabled v-model="entity.ys.zqsbNyd"> </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6" :offset="4">
          <el-form-item label="新增耕地" prop="ys.zqsbGd" :rules="rules.num">
      ...
      <el-row>
        <el-col :span="6" :offset="4">
          <el-form-item label="新增农用地" prop="ys.rkXznyd" :rules="rules.num">
            <el-input :disabled="disabled" v-model="entity.ys.rkXznyd">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6" :offset="4">
          <el-form-item label="新增耕地" prop="ys.rkXzgd" :rules="rules.num">
            <el-input :disabled="disabled" v-model="entity.ys.rkXzgd">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
import { getRules, checkValidate } from "@/tdzz/verification/zjggYs";
import { ref, reactive, toRefs } from "@vue/reactivity";
import { ElMessage } from "element-plus";
import { useRoute } from "vue-router";
import { onMounted, onBeforeUnmount, computed } from "@vue/runtime-core";
import bus from "@/common/utils/bus";
import { init, saveOrUpdate } from "@/tdzz/api/proj/proj-zjgg-ys.js";
...
onMounted(() => {
  ...
  F_init();
  //2.定义监听事件
  bus.on("zjgg_ysxx_save", async (callback) => {
