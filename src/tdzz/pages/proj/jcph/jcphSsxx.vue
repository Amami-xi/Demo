...
import { getRules, checkValidate } from "@/tdzz/verification/jcphSs";
import { ref, reactive, toRefs } from "@vue/reactivity";
import { init, saveOrUpdate } from "@/tdzz/api/proj/proj-jcph-ss";
...
const { disabled, entity, rules } = toRefs(data);
...
onMounted(() => {
  ...
  F_init();
  //2.定义监听事件
  bus.on("jcph_ssxx_save", async (callback) => {
